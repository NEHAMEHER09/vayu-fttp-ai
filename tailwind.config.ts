    ...
    extend: {
      ...
      colors: {
        ...
        sidebar: {
          ...
          "item-active-foreground": "hsl(var(--sidebar-item-active-foreground))",
          "item-hover": "hsl(var(--sidebar-item-hover))",
        },
        success: "hsl(var(--success))",
        warning: "hsl(var(--warning))",
        info: "hsl(var(--info))",
        "chart-fiber": "hsl(var(--chart-fiber))",
        "chart-equipment": "hsl(var(--chart-equipment))",
        "chart-labour": "hsl(var(--chart-labour))",
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 20px -5px hsl(168 80% 45% / 0.2)" }, "50%": { boxShadow: "0 0 30px -5px hsl(168 80% 45% / 0.4)" } },
